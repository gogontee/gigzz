                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      {/* Title */}
                      <h2 className="text-xl font-bold mb-3 text-gray-900 group-hover:text-orange-400 transition-colors duration-200 line-clamp-2">
                        {item.title}
                      </h2>
                        ...
                        {!expanded[item.id] ? (
                          ...
                          >
                            ...
                            <motion.button
                              ...
                              className="flex items-center gap-1 text-black font-semibold hover:text-orange-400 transition-colors duration-200 group/btn"
                              whileHover={{ x: 2 }}
                            >
                              Read more
                              <svg 
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col gap-4 max-w-md mx-auto">
                <div className="flex flex-col sm:flex-row gap-3">
                  <input
                    ...
                    className="flex-1 px-4 py-3 rounded-xl text-black focus:outline-none focus:ring-2 focus:ring-orange-400 placeholder-gray-500"
                ...
                <motion.button
                  type="submit"
                  disabled={subscribing}
                  className="bg-orange-400 text-white px-6 py-3 rounded-xl font-semibold hover:bg-orange-500 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
