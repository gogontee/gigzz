...
import JobApplicationTerms from "../components/JobApplicationTerms";

export default function Terms() {
  const [showJobTermsModal, setShowJobTermsModal] = useState(false);
  const [acceptedJobTerms, setAcceptedJobTerms] = useState(false);
  
  const handlePrint = () => window.print();
  const handleBack = () => window.history.back();

  const openJobTermsModal = () => {
    setShowJobTermsModal(true);
  };

  const closeJobTermsModal = () => {
    setShowJobTermsModal(false);
  };

  const acceptJobTerms = () => {
    setAcceptedJobTerms(true);
    setShowJobTermsModal(false);
  };

  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 text-gray-900 py-8 px-4 sm:px-6 lg:px-8">
      {/* Job Application Terms Modal */}
      {showJobTermsModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            <JobApplicationTerms
              onAccept={acceptJobTerms}
              isAccepted={acceptedJobTerms}
              onClose={closeJobTermsModal}
            />
          </div>
        </div>
      )}
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-1/4">
            <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-8 border border-gray-200">
              ...
              {/* Job Application Terms Quick Action */}
              <div className="mt-6 pt-6 border-t border-gray-200">
                <button
                  onClick={openJobTermsModal}
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-black to-gray-800 text-white rounded-lg hover:from-orange-600 hover:to-orange-500 transition-all duration-200 font-medium mb-3"
                >
                  <FaFileContract />
                  View Job Application Terms
                </button>
                ...
                {acceptedJobTerms && (
                  <div className="p-3 bg-green-50 border border-green-200 rounded-lg text-center">
                    <div className="flex items-center justify-center gap-2 text-green-700 text-sm">
                      <FaUserCheck />
                      <span className="font-medium">Job Terms Accepted</span>
                    </div>
                  </div>
                )}
                ...
                <button
                  onClick={handlePrint}
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors duration-200 font-medium mt-3"
                >
                  <FaPrint />
                  Print / Save PDF
                </button>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
              ...
              <section id="section-5" className="mb-8 scroll-mt-8">
                ...
                <div className="ml-12">
                  <div className="bg-gradient-to-r from-orange-50 to-orange-100 border border-orange-200 rounded-xl p-6 mb-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <h3 className="text-xl font-bold text-gray-900">MyGigzz Job Application Terms & Conditions</h3>
                      </div>
                    ...
                    <p className="text-gray-700 mb-6">
                      These terms govern all job applications on the MyGigzz platform. They cover important aspects including token usage, employer verification, fraud reporting, and your responsibilities as an applicant.
                    </p>
                    
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                      <div className="bg-white p-4 rounded-lg border border-gray-200">
                        <div className="text-orange-500 font-bold text-lg mb-2">Tokens</div>
                        <p className="text-sm text-gray-600">Learn about token-based applications and fees</p>
                      </div>
                      <div className="bg-white p-4 rounded-lg border border-gray-200">
                        <div className="text-orange-500 font-bold text-lg mb-2">Verification</div>
                        <p className="text-sm text-gray-600">Understand employer verification status</p>
                      </div>
                      <div className="bg-white p-4 rounded-lg border border-gray-200">
                        <div className="text-orange-500 font-bold text-lg mb-2">Fraud</div>
                        <p className="text-sm text-gray-600">How to report suspicious activities</p>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-4">
                      <button
                        onClick={openJobTermsModal}
                        className="px-6 py-3 bg-gradient-to-r from-black to-gray-800 text-white rounded-lg hover:from-orange-600 hover:to-orange-500 transition-all duration-200 font-medium flex items-center gap-2"
                      >
                        <FaFileContract />
                        {acceptedJobTerms ? 'Review Terms' : 'Read Full Terms'}
                      </button>
                      
                      <button
                        onClick={acceptJobTerms}
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    By applying for jobs on MyGigzz, you agree to the specific Job Application Terms. These terms are in addition to and complement the general Terms of Service. Key points include token usage policies, employer verification guidelines, and fraud reporting procedures.
                  </p>
                </div>
              </section>

              {/* Section 6: Tokens & Payments */}
              ...
              <section id="section-8" className="mb-8 scroll-mt-8">
                <div className="flex items-center mb-4">
                  <div className="bg-red-100 p-2 rounded-lg mr-4">
                    <span className="text-red-600 font-bold text-lg">8</span>
                  </div>
              ...
              <section id="section-9" className="mb-8 scroll-mt-8">
                <div className="flex items-center mb-4">
                  <div className="bg-indigo-100 p-2 rounded-lg mr-4">
                    <span className="text-indigo-600 font-bold text-lg">9</span>
                  </div>
              ...
              <section id="section-10" className="mb-8 scroll-mt-8">
                <div className="flex items-center mb-4">
                  <div className="bg-teal-100 p-2 rounded-lg mr-4">
                    <span className="text-teal-600 font-bold text-lg">10</span>
                  </div>
                ...
                <section id="section-11" className="mb-8 scroll-mt-8">
                  <div className="flex items-center mb-4">
                    <div className="bg-orange-100 p-2 rounded-lg mr-4">
                      <span className="text-orange-600 font-bold text-lg">11</span>
                    </div>
                ...
                <section id="section-12" className="mb-8 scroll-mt-8">
                  <div className="flex items-center mb-4">
                    <div className="bg-gray-100 p-2 rounded-lg mr-4">
                      <span className="text-gray-600 font-bold text-lg">12</span>
                    </div>
                ...
                <section id="section-13" className="mb-8 scroll-mt-8">
                  <div className="flex items-center mb-4">
                    <div className="bg-purple-100 p-2 rounded-lg mr-4">
                      <span className="text-purple-600 font-bold text-lg">13</span>
                    </div>
                ...
                <section id="section-14" className="mb-8 scroll-mt-8">
                  <div className="flex items-center mb-4">
                    <div className="bg-green-100 p-2 rounded-lg mr-4">
                      <span className="text-green-600 font-bold text-lg">14</span>
                    </div>
                ...
                <section id="section-16" className="mb-8 scroll-mt-8">
                  <div className="flex items-center mb-4">
                    <div className="bg-indigo-100 p-2 rounded-lg mr-4">
                      <span className="text-indigo-600 font-bold text-lg">16</span>
                    </div>
                ...
                <section id="section-17" className="mb-8 scroll-mt-8">
                  <div className="flex items-center mb-4">
                    <div className="bg-gray-100 p-2 rounded-lg mr-4">
                      <span className="text-gray-600 font-bold text-lg">17</span>
                    </div>
                ...
                {/* Section 18: Contact */}
                <section id="section-18" className="mb-8 scroll-mt-8">
                  <div className="flex items-center mb-4">
                    <div className="bg-red-100 p-2 rounded-lg mr-4">
