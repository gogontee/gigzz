...
// Lazy import LearnMoreForm
const LearnMoreForm = dynamic(() => import("../components/LearnMoreForm"), { ssr: false });
    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-gray-100">
      ...
      <aside className="w-full md:w-1/4 bg-white shadow-md p-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <button
            onClick={() => setOpenMenu(openMenu === "learnMore" ? null : "learnMore")}
      ...
      <main className="flex-1 p-6 md:p-12 overflow-y-auto">
        {activeContent === "add" && (
          <div className="bg-white p-6 rounded shadow-md">
            <h2 className="text-xl font-semibold mb-4">Add Learn More Content</h2>
            <LearnMoreForm />
          </div>
        )}
        ...
        {activeContent === "edit" && (
          <div className="bg-white p-6 rounded shadow-md">
            <h2 className="text-xl font-semibold mb-4">Edit Learn More Content</h2>
        ...
        {activeContent === "delete" && (
          <div className="bg-white p-6 rounded shadow-md">
            <h2 className="text-xl font-semibold mb-4">Delete Learn More Content</h2>
